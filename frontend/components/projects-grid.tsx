...
import { MapPin, Users, Target, TrendingUp, Heart } from "lucide-react"
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <p className="text-muted-foreground">{projects.length} projetos encontrados</p>
      </div>
            ...
            <Card key={project.id} className="overflow-hidden hover:shadow-lg transition-shadow">
              ...
              <CardFooter>
                <Button className="w-full" disabled={project.status === "inativo"}>
                  {project.status === "ativo" ? "Ver Detalhes" : "Projeto Inativo"}
                </Button>
              </CardFooter>
            </Card>
          )
